...
function draw() {
  ...
  if(isTouching(movingSprite,fixSprite4 && ball.bounceOff(block1))){
  ...
  else if(isTouching(movingSprite,fixSprite3 && ball.bounceOff(block1))){
    { ball.shapeColor = rgb(0,0,255); 
      music.stop(); }
  ...
  else if(isTouching(movingSprite,fixSprite2 && ball.bounceOff(block1))){
    { ball.shapeColor = rgb(0,0,255);
       music.stop(); }
  ...
  else if(isTouching(movingSprite,fixSprite1 && ball.bounceOff(block1))){
    { ball.shapeColor = rgb(0,0,255);
       music.stop(); }
